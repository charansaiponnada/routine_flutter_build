...
final todayCompletionProgressProvider = AutoDisposeProvider<double>.internal(
  todayCompletionProgress,
  name: r'todayCompletionProgressProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$todayCompletionProgressHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
